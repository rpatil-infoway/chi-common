...
//		state.pageData.name = state.pageData.name  + " (" + state.pageData.jurisdictionKey + ")";
		...
		state.pageData.ContentPageTitle = AJS.I18n.getText("confluence.empty.space.blueprint.homepage.suffix");
//        console.log(state);
//        console.log(e);
...
//		return false;
    ...
    Confluence.Blueprint.setWizard('ca.infoway.confluence.plugins.chi-common:chi-empty-space-blueprint-item', function(wizard) {
